 ...
 */
export function collectIndents(document: ReplReadline, offset: number, maxDepth: number = 3, maxLines: number = 20): IndentInformation[] {
...
export function getIndent(document: ReplReadline, offset: number): number {
